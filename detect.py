...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/exp21/weights/best.pt', help='model.pt path(s)')
    ...
    # opt.device = "0"
    # opt.weights = "/root/chenguang/project/yolov5-master/runs/train/exp16/weights/best.pt"
    # opt.source = "/root/chenguang/project/yolov5-master/data/1.mp4"
    # opt.img_size = 320
    # opt.conf_thres = 0.3
